      ...
      <table class="table table-striped table-responsive table-hover table-bordered">
        ...
        <tbody id="myTable">
          ...
          <tr>
            ...
            <td>
              <a href="<?php echo base_url().'admin/store/edit/'.$store['r_id']?>" class="btn btn-info mb-1"><i
                  class="fas fa-edit mr-1"></i>Edit</a>

              <a href="<?php echo base_url().'admin/store/delete/'.$store['r_id'] ?>" class="btn btn-danger"><i

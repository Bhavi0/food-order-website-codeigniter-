      ...
      <table class="table table-bordered table-hover table-striped table-responsive">
        ...
        <tbody id="myTable">
          ...
          <tr>
            ...
            <td>
              <a href="<?php echo base_url().'admin/menu/edit/'.$dish['d_id']; ?>" class="btn btn-info mb-1"><i
                  class="fas fa-edit mr-1"></i>Edit</a>

              <a href="<?php echo base_url().'admin/menu/delete/'.$dish['d_id'] ?>" class="btn btn-danger"><i
